export const guidelines = [
    ...
    },
    {
        ...
        rules:[
            ...
            "Participants should bring their own kit and necessary components and a laptop (if required).",
            "Participants should bring 3 hard copies of abstract on the day of event.",
            "Participants should mail project abstract to project@synergyxv.in within (19.04.2022).",
